...
<template>
  <section ref="target" class="services__section" id="scrollTo_services">
    <article class="services__article">
      <img class="services__image" src="../images/loudspeaker-icon.png" alt="">
    ...
    <article class="services__article">
      <img class="services__image" src="../images/workstation-icon.png" alt="">
      <div class="servives__article_text-box">
    ...
    <article class="services__article">
      <img class="services__image" src="../images/home-address-icon.png" alt="">
      <div class="servives__article_text-box">
